...
//    public static List<Word> wordListGotFromFireBase = new ArrayList<>();
//    public static List<Word> getWordList() {
//        return wordListGotFromFireBase;
//    }
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wordDAO.getAll(new OnGetAllListener<Word>() {
            @Override
    ...
    private void loadContentForText(Word word){
        ...
        meaningText.setText(word.getNghia()+"\n"+word.getPhatAm());
