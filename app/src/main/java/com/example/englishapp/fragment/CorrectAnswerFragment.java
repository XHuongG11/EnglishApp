...
public class CorrectAnswerFragment extends Fragment {
    ...
    private Sound sound;
    public CorrectAnswerFragment(Question sentence) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.correct_answer_feedback, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Thiết lập nội dung
        tvSentence.setText(sentence.getMeaning());
